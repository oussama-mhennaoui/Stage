 ...
 */
final class Version20250923170808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE encadrement (id INT AUTO_INCREMENT NOT NULL, etudiant_id INT NOT NULL, enseignant_id INT NOT NULL, status VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL, cv_name VARCHAR(255) DEFAULT NULL, INDEX IDX_BF024B09DDEAB1A3 (etudiant_id), INDEX IDX_BF024B09E455FCC0 (enseignant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, num_tel VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, roles JSON NOT NULL, is_verified TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', dtype VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE encadrement ADD CONSTRAINT FK_BF024B09DDEAB1A3 FOREIGN KEY (etudiant_id) REFERENCES etudiant (id)');
        $this->addSql('ALTER TABLE encadrement ADD CONSTRAINT FK_BF024B09E455FCC0 FOREIGN KEY (enseignant_id) REFERENCES enseignant (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE encadrement DROP FOREIGN KEY FK_BF024B09DDEAB1A3');
        $this->addSql('ALTER TABLE encadrement DROP FOREIGN KEY FK_BF024B09E455FCC0');
